...
(function() {
  ...
  var API_WORLDTIME_KEY = "3085f9b347c945229aa82058163010";
  var API_WORLDTIME = "https://api.worldweatheronline.com/free/v2/tz.ashx?format=json&key="+ API_WORLDTIME_KEY +"&q=";
  var API_WEATHER_KEY = "63d9f012700765c895ea49a9b31e4152";
  ...
  function activateTemplate(id) {
    ...
    return document.importNode(t.content, true); //Crear una copia de mi template
  }
  ...
  function loadSavedCities(e) {
    ...
    $(".card").on("click", function(e) {
      ...
      //Como ya elimino una ciudad de la interfaz aqui tambine la borra del objeto d cities y  luego transforma y guarda la cadena de cities
      //actualizada en el localStorage
      cities.splice(i,1);
      console.log(cities);
      localStorage.setItem('cities', JSON.stringify(cities) );
    });
